  ...
  getSongsByQuery = (id) => {
    API.getSongsByQuery(id)
      .then((res) => {
        this.setState({
          ...this.state,
          songInfo: [...this.state.songInfo, res.data[0]],
        });
  ...
  getPurchaseSongsByQuery = (id) => {
    API.getSongsByQuery(id)
      .then((res) => {
        this.setState({
          ...this.state,
          purchaseSongsInfo: [...this.state.purchaseSongsInfo, res.data[0]],
        });
        this.setState({
          ...this.state,
          purchaseSongs: this.state.purchaseSongsInfo,
        });
      })
      .catch((err) => console.log(err));
  };
  getTutorialsByQuery = (id) => {
    API.getTutorialsByQuery(id)
      .then((res) => {
        this.setState({
          ...this.state,
          tutorialInfo: [...this.state.tutorialInfo, res.data[0]],
        });
            ...
            <div className="container mx-auto" style={{ marginTop: "0px" }}>
              ...
              <div className="text-center mt-3">
                <h3 className="text-4xl font-semibold leading-normal text-gray-800">
                  {this.state.firstName}'s Song List
                </h3>
                              ...
                              <GridItem className="pt-0 pb-0">
                                ...
                                >
                                  ...
                                  {this.state.songs.map((song) => (
                                    <li style={liststyle}class="list-group-item d-flex justify-content-between">
                                      <Row className="w-100">
